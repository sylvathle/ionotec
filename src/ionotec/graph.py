...
def plot_map(df_station,station_name,timestamp,data_col='VTEC',lon_density=100,lat_density=100,show_html=False):
    ...
    print(f"Saved image {station_name}")
    if show_html: fig.show()
    fig.write_image(target_dir+"/"+station_name+".png",width=720,height=405,scale=2)
